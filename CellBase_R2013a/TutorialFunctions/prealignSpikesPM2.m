function  prealignSpikesPM2(mycellids,varargin)
...
%   Edit log: AK 11/06; 2/11, BH 6/27/11, 5/10/12 PM 7/7/14
...
for i = 1:length(mycellids)
    ...
    [event_stimes,event_windows] = extractEventSpikesPM2(cellid,events,EV);
