...
labels_colors = { ...
        ...
        'trialOutcome=1',                 'Reward',              [0 0.5 1],           [],       '-';   ...        
        'trialOutcome=2',                 'Punish',              [1 0.5 0],           [],       '-';   ...                
        'trialOutcome=3',                 'Neutral',              [0 0 0],           [],       '-';   ...     
        'cueCondition=0',                 'Uncued',              [0 0 0],           [],       '-';   ...             
        'cueCondition=2',                 'High value',              [0 0 1],           [],       '-';   ...                     
        'cueCondition=1',                 'Low value',              [1 0 0],           [],       '-';   ...                             
        'trialType=1',                 'High Value, reward',              [0 0 1],           [],       '-';   ...               
        'trialType=4',                 'Low Value, reward',              [1 0 0],           [],       '-';   ...                       
        'trialType=7',                 'Uncued, reward',              [0 1 0],           [],       '-';   ...                               
    };