...
% January 26, 2001
	...
	if strcmp(get(gh.standardModeGUI.grabOneButton, 'Visible'), 'off')		% BSMOD2 eliminated variable 'visible'
		return
	end
	...
	if state.piezo.usePiezo
		...
		if strcmp(get(gh.standardModeGUI.grabOneButton, 'String'), 'GRAB')		% BSMOD2 eliminated variable 'val'
