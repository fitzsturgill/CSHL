...
% Last Modified by GUIDE v2.5 06-May-2014 15:07:29
...
function autoSave_Callback(hObject, eventdata, handles)
	genericCallback(hObject);
%     %FS MOD
%     if state.phys.mcAcq.mcInputBoardIndex>0
%         if get(hObject, 'Value')
%             set(state.phys.mcAcq.mcInputDevice, 'LoggingMode', 'Disk&Memory');
%         else
%             set(state.phys.mcAcq.mcInputDevice, 'LoggingMode', 'Memory');
%         end
%     end
