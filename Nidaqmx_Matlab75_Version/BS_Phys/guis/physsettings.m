...
% Last Modified by GUIDE v2.0 05-Sep-2002 15:42:53
...
function varargout = outputRate_Callback(h, eventdata, handles, varargin)
    ...
    if state.phys.daq.auxOutputBoardIndex>0
    	outputRate=setverify(state.phys.daq.auxOutputDevice, 'SampleRate', state.phys.settings.outputRate*1000)/1000;  
    end
