...
% Last Modified by GUIDE v2.5 29-Oct-2003 15:02:25
...
% --------------------------------------------------------------------
function varargout = epoch_Callback(h, eventdata, handles, varargin)
	genericCallback(h);
	global state
	addEntryToNotebook(2, [datestr(clock,13) ' : Changed epoch to ' num2str(state.epoch)]);
