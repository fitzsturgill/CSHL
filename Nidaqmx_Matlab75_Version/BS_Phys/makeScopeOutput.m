function makeScopeOutput
	...
	state.phys.scope.pointsUntilOutputPulse=round(width*state.phys.scope.actualOutputRate/2);
	state.phys.scope.pointsUntilInputPulse=round(width*state.phys.scope.actualInputRate/2);
  ...
  %  state.phys.scope.output=amp*(sin((0:4*state.phys.scope.pointsUntilOutputPulse-1)/80))';
	%setWave('scopeOutput', 'data', state.phys.scope.output, 'xscale', [0 1/state.phys.scope.actualOutputRate]);
	
	setWave('scopeInputFit', 'xscale', [width/2-1/state.phys.scope.actualOutputRate 1/state.phys.scope.actualInputRate]);
