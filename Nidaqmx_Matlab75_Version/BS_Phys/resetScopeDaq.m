function resetScopeDaq
    ...
    set(state.phys.daq.scopeOutputChannel, 'OutputRange', [-10 10], 'UnitsRange', [-10 10]);  %FS MOD
    ...
    set(state.phys.daq.scopeInputChannel, 'SensorRange', [-10 10], 'UnitsRange', [-10 10]); %FS MOD    
