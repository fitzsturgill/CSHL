...
% MOVIEGUI Application M-file for movieGUI.fig
%    FIG = MOVIEGUI launch movieGUI GUI.
%    MOVIEGUI('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.0 18-Aug-2001 10:03:40
