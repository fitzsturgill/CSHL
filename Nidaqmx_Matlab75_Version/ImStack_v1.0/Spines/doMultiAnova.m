...
h = waitbar(0,'Starting To ANOVA Spine Data Files....', 'Name', 'ANOVA of Neurons', 'Pointer', 'watch', ...
...
for i = 1:total
	...
	totalAnnovaName = [totalAnnovaName annovaName];
	totalAnnovaZerName = [totalAnnovaZerName zerosRemovedAnova];
...
switch type
case 'density2d'
	[p2d,tbl2d,stat2d] = anova1(total2dDensity, totalAnnovaName, display);
	...
	out = p2d;
case 'density3d'
	[p3d,tbl3d,stat3d]= anova1(total3dDensity, totalAnnovaName,  display);
	if strcmp(compare, 'yes')
		figure('pos', [232   130   661   548]);
	...
	out = p3d;
case 'length'
	[pLen,tblLen,statLen]= anova1(totalLen, totalAnnovaZerName, display);
	if strcmp(compare, 'yes')
		figure('pos', [232   130   661   548]);
	...
	out = pLen;
case 'volume'
	[pVol,tblVol,statVol] = anova1(totalVol, totalAnnovaZerName,  display);
	if strcmp(compare, 'yes')
		figure('pos', [232   130   661   548]);
