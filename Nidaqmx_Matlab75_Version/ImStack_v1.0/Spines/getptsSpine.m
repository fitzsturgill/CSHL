function [x,y] = getptsSpine(varargin)
...
case {13, 3, 32}   % enter and return keys, space
...
global GETPTS_FIG GETPTS_AX GETPTS_H1 GETPTS_H2 bit
...
if (~strcmp(get(GETPTS_FIG, 'SelectionType'), 'normal')) & (~strcmp(get(GETPTS_FIG, 'SelectionType'), 'open'))
    % We're done!
    set(GETPTS_H1, 'UserData', 'Completed');
else
...
if (~strcmp(get(GETPTS_FIG, 'SelectionType'), 'normal')) & (~strcmp(get(GETPTS_FIG, 'SelectionType'), 'open')) & (~strcmp(get(GETPTS_FIG, 'SelectionType'), 'extend'))
    % We're done!
    set(GETPTS_H1, 'UserData', 'Completed');
end
