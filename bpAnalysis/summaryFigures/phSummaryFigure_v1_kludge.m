...
%% Histograms    
    ...
    phSessionAvg_kludge(session.SessionData, [1 2], [2 4], '', hAx(2), {'g', 'r'});
    xlabel('Time (s) from tone'); ylabel('dF/F');
    phSessionAvg_kludge(session.SessionData, [1 1 1], [2 3 4], '', hAx(3), {'g', 'k', 'r'});
    xlabel('Time (s) from tone'); ylabel('dF/F'); textBox('Tone A');
    phSessionAvg_kludge(session.SessionData, [2 2 2], [2 3 4], '', hAx(4), {'g', 'k', 'r'});
