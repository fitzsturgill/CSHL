function formatFigureTalk(wh, h)
...
%% for .eps, .tif, .jpg,  screen units matter
    ...
    set(bax, 'TickDir', 'out', 'LineWidth', 1, 'FontSize', 16, 'FontName', 'Calibri', 'Box', 'off');
    set(gcf, 'Units', units, 'PaperUnits', units, 'PaperSize', [wh(1) wh(2)], 'Color', [1 1 1]);
