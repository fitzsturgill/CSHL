%{
FrankenLNL_varyRewardSize_addAnimal
FrankenLNL_4odors
RewardPunish blocks
Block #10
4 trial types: 1- 10uL reward, 2- 5uL reward, 3- 2uL reward 
%}
...
%% process photometry
% baseline by trial
 TE.Photometry = processTrialAnalysis_Photometry2(sessions, 'dFFMode', dFFMode, 'blMode', 'byTrial', 'zeroField', 'Cue2', 'channels', channels, 'baseline', BL, 'expFitBegin', 0.4);
 TE.PhotometryExpFit = processTrialAnalysis_Photometry2(sessions, 'dFFMode', dFFMode, 'blMode', 'expFit', 'zeroField', 'Cue2', 'channels', channels, 'baseline', BL, 'expFitBegin', 0.4);
