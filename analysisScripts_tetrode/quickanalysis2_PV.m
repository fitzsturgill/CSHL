function quickanalysis2(animalNO,sessionID,sessionspec,protocoltag)
...
% Directories
global DATAPATH
resdir = ['D:\analysis\' whichcb '\_response_profiles\' animalID2 '\'];
if ~isdir(resdir)
    mkdir(resdir)
end
resdir2 = ['D:\analysis\' whichcb '\_behavior\' animalID2 '\'];
if ~isdir(resdir2)
    mkdir(resdir2)
end
